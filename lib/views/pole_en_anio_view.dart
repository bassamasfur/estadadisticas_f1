...
class PoleEnAnioView extends StatefulWidget {
  const PoleEnAnioView({super.key});

  @override
  State<PoleEnAnioView> createState() => _PoleEnAnioViewState();
}

class _PoleEnAnioViewState extends State<PoleEnAnioView> {
  bool _loading = true;
  String? _error;
  List<dynamic> _data = [];
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'https://f1-3f1tsyn2d-bassans-projects.vercel.app/api/poles/poles-en-un-anio',
        ),
      );
      ...
      body: _loading
          ...
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final carreras = item['carreras'] as int? ?? 0;
                final porcentaje = item['porcentaje'] ?? '';
                Color bgColor;
