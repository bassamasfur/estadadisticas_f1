...
class PoleConsecutivoView extends StatefulWidget {
  const PoleConsecutivoView({super.key});

  @override
  State<PoleConsecutivoView> createState() => _PoleConsecutivoViewState();
}

class _PoleConsecutivoViewState extends State<PoleConsecutivoView> {
  bool _loading = true;
  String? _error;
  List<dynamic> _data = [];
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'https://f1-3zjhdeimp-bassans-projects.vercel.app/api/poles/poles-consecutive',
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pole Position consecutivas'),
